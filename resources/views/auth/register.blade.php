                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                            ...
                            <div class="form-group{{ $errors->has('loginCode') ? ' has-error' : '' }}">
                                <label for="name" class="col-md-4 control-label">Mã sinh viên/Giảng viên</label>

                                <div class="col-md-12">
                                    <input id="logincode" type="text" class="form-control" name="loginCode" value="{{ old('loginCode') }}" required autofocus>
