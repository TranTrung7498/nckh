                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-success">
                                ...
                                <p class="card-category">Danh sách thông báo</p>
                            </div>
                            <div class="card-body">
                                ...
                                <table class="table table-bordered" id="myTable">
                                    ...
                                    @foreach($data as $dt)
                                        <tr>
                                            <td>{{$i++}}</td>
                                            <td>{{$dt->description}}<br>
                                                <a href="{{url('admin/message/detail/'.$dt->id)}}" class="text-purple">Chi tiết</a>
                                            </td>
                                            <td>{{$dt->sender}}</td>
                                            <td>{{$dt->receiver}}</td>
                                            <td>{{$dt->date}}</td>
                                            ...
                                            <td>
                                                <a href="{{ url('admin/message/delete/'.$dt->id) }}" class="btn btn-danger btn-sm"
                                                   data-tr="{{$dt->id}}"
