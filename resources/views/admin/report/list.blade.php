                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-success">
                                <h4 class="card-title">Danh sách báo cáo tiến độ</h4>
                                <p class="card-category">Danh sách báo cáo tiến độ đề tài nghiên cứu khoa học của sinh viên trường Đại học Tài nguyên và Môi trường Hà Nội</p>
                            </div>
                            <div class="card-body">
                                <div class="col-md-12">
                                    <div class="row">
                                    ...
                                    <table class="table table-bordered table-hover display" id="myTable">
                                        ...
                                        @foreach($data as $dt)
                                            <tr>
                                                ...
                                                <td>{{$dt->status}}</td>
                                                <td>
                                                    <a href="{{ url('admin/report/delete/'.$dt->id) }}" class="btn btn-danger btn-sm"
                                                       data-tr="{{$dt->id}}"
