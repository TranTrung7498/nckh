                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-success">
                                <h4 class="card-title">Danh sách đề tài đang được thực hiện</h4>
                                <a href="{{url('admin/report/getdetail')}}" class="btn btn-success pull-right">Danh sách báo cáo</a>
                                <p class="card-category">Danh sách đề tài nghiên cứu khoa học đang được thực hiện của sinh viên trường Đại học Tài nguyên và Môi trường Hà Nội</p>
                            </div>
                            <div class="card-body">
                                <div class="col-md-12">
                                    <div class="row">
                                    ...
                                    <table class="table table-bordered table-hover display" id="myTable">
                                        ...
                                        @foreach($detai as $dt)
                                            <tr>
                                                ...
                                                <td>{{$dt->status}}</td>
                                                <td>
                                                    <a href="{{ url('admin/report/add/'.$dt->id) }}" class="btn btn-primary btn-sm"
                                                       data-tr="{{$dt->id}}"
