            ...
            <div class="row">
                ...
                <div class="card">
                    <div class="card-header card-header-success">
                        <a href="{{url('admin/search/export')}}" class="btn btn-warning pull-right">Xuất Excel</a>
                    ...
                    <div class="card-body">
                        <form class="navbar-form" role="form" method="post" action="{{url('admin/search/postSearch')}}">
                            {{ csrf_field() }}
