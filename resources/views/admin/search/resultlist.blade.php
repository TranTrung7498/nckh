                                ...
                                <table class="table table-bordered" id="myTable">
                                    ...
                                    @foreach($data as $dt)
                                        <tr>
                                            <td>{{$i++}}</td>
                                            <td>{{$dt->name}}<br>
                                                <a href="{{url('admin/search/detail/'.$dt->id)}}" class="text-purple">Chi tiết</a>
                                            </td>
                                            ...
                                            <td>{{$dt->rating}}</td>
                                            <td>
                                                <a href="{{ url('admin/search/update/'.$dt->id) }}" class="btn btn-warning btn-sm"
                                                   data-tr="{{$dt->id}}"
                                            ...
                                            <td>
                                                <a href="{{ url('admin/search/delete/'.$dt->id) }}" class="btn btn-danger btn-sm"
                                                   data-tr="{{$dt->id}}"
                                                   data-placement="left" data-singleton="true">
                                                    Xóa
                                                </a>
...
@section('page-scripts')
    <script>
        ...
        var node = document.createTextNode("Tổng số đề tài phù hợp với điều kiện: "+ $row +"  đề tài.");
        p.appendChild(node);
