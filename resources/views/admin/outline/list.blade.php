                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-success">
                                    <h4 class="card-title">Danh sách đề tài chờ xét duyệt</h4>
                                    <a href="{{url('admin/outline/listUpdate')}}" class="btn btn-primary pull-right">Kết quả</a>
                                <p class="card-category">Danh sách đề tài nghiên cứu khoa học chờ xét duyệt của sinh viên trường Đại học Tài nguyên và Môi trường Hà Nội</p>
                            </div>
                            <div class="card-body">
                                <div class="col-md-12">
                                    <div class="row">
                                ...
                                <table class="table table-bordered" id="myTable">
                                    <tr>
                                        ...
                                        <th style="width: 120px">Xét duyệt</th>
                                    </tr>
                                    <?php $i =1 ?>
                                    @foreach($detai as $dt)
                                    <tr>
                                        ...
                                        <td>{{$dt->name}}</td>
                                                ...
                                                <td>{{$dt->status}}</td>
                                                <td>
                                                    <a href="{{ url('admin/outline/post/'.$dt->id) }}" class="btn btn-success btn-sm"
                                                       data-tr="{{$dt->id}}"
